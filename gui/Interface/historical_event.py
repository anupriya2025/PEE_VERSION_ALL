...
import io
import platform
import customtkinter as ctk   # ✅ Import the module, not individual CTK
...
class HistoricalEventInterface(CTkFrame):
    ...
    def __init__(self, parent,*args, root_width: int = 1920, root_height: int = 1080, **kwargs):
        ...
        self.root=parent
        self.winfo_toplevel().title("Event Details ")
    ...
    def setup_historical_ui(self):
        print("""Create historical events UI layout""")
        # Main frame
    ...
    def create_events_grid(self):
        print("""Create scrollable grid for events""")
    ...
    def create_event_card(self, event, row, col):
        print("""Create individual event card""")
        # Main card frame
    ...
    def load_historical_events(self):
        print("""Load all historical events from database***********************************************""")
        try:
    ...
    def update_events_display(self):
        print("""Update events display with current page""")
    ...
    def start_event_update_thread(self):
        pass
        # print("""Start separate thread for periodic event updates""")
        # def event_updater():
        #     while True:
        #         try:
