...
class EventDatabase:
    ...
    def fetch_Camera_deatils(self):
                ...
                try:
                    # Read FETCH_LIMIT from config file (default = 4 if not found)
                    # fetch_limit = self.config.getint("CAMERA", "FETCH_LIMIT")
    ...
    def update_video_path(self, event_id, video_path):
        ...
        try:
          ...
          self.logger.exception("DB ERROR (Unified Video Path Update):", e)
