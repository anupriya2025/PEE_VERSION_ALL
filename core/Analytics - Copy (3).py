...
#                         last_status = None
#                         if self.same_status_count[person_id] >=30:
#                             try:
...
#                                             print("inserted  for change status ID : ",event_id_str)
...
#                                     try:
#                                             event_id_str = f"{person_id}"
#                                             print("inserted  first time as ID : ",event_id_str)
#                                             self.event_queue.put((frame, person_id, cam_id, detection_result, bbox,event_id_str),block=False )
...
#                         #     try:
#                         #         event_id_str = f"{person_id}"
#                         #         print("inserted id ",event_id_str)
#                         #         self.event_queue.put((frame, person_id, cam_id, detection_result, bbox,event_id_str),block=False )
#                         #     except queue.Full:
#                         #         pass   
#                         #     if person_id not in self.last_inserted_status:
#                         #         self.last_inserted_status[person_id] = []
